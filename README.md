...
This repository introduces a new Gemini Command Line Interface (CLI) extension that integrates Google's File Search feature. This tool establishes a fully managed Retrieval-Augmented Generation (RAG) system directly on the command line.
